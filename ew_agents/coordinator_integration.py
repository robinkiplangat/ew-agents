...
class EnhancedCoordinator:
    ...
    async def _delegate_summary_to_coordinator(self, user_request: str, 
        ...
        try:
            ...
            # Use the comprehensive analysis template as the base
            report_template = ElectionWatchReportTemplate.get_comprehensive_analysis_template()
            
            # Populate the template with agent results
            populated_report = self._populate_report_template(
